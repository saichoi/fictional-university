...
class Search {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keydown", this.keyPressDispatcher.bind(this)); // keyup : 한번만 동작. keydown : 여러번 동작.
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON('http://localhost:10003/wp-json/wp/v2/posts?search=' + this.searchField.val(), posts => {
      this.resultsDiv.html(`
