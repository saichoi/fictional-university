...
function university_files () {
    wp_enqueue_script("googleMap", "//maps.googleapis.com/maps/api/js?key=AIzaSyAGUjr25yj4NzGkWo2LYtKVnR-th8ILzSY", NULL, "1.0", true);
...
function makeNotePrivate($data, $postarr) {
    if ($data['post_type'] === 'note') {
        // 현재 가지고 있는 note type post가 5개이고 포스트 ID가 없는 경우(신규)
...
function bannerBlock() {
    wp_register_script('bannerBlockScript', get_stylesheet_directory_uri() . '/build/banner.js', array('wp-blocks', 'wp-editor', 'wp-element', 'wp-components', 'wp-block-editor'));
    register_block_type("ourblocktheme/gbanner", array(
