        ...
        <div className="paying-attention-frontend">
            ...
            <ul>
                {props.answers.map((answer, index)=>{
                    ...
                    return (
                        <li className={(isCorrect === true && index == props.correctAnswer ? "no-click" : "") + (isCorrectDelayed === true && index != props.correctAnswer ? "fade-incorrect" : "")} onClick={isCorrect === true ? undefined : () => handleAnswer(index)}>
